...
//    ModeloUsuario modUsuario;
    ...
    public void logar() {
        ...
        try {
            ...
            if (rs.next()) {
                //a linha abaixo obtem o conteudo do cammpo 6 perfil da tabela tbusuarios
                String perfil = rs.getString(6);
                //System.out.println(perfil);
                // a estrutura abaixo faz o tratamento do perfil do usuario
                if (perfil.equals("admin")) { // não usar == com strings, usar .equals
//                    MenuPrincipal principal = new MenuPrincipal();
//                    principal.setVisible(true);   

                    // seta usuario e senha na pagina principal
                    MenuPrincipal.lblUsuario.setText(rs.getString(2));
                    MenuPrincipal.lblUsuario.setForeground(Color.red);// pinta nome de vermelho quando for admin
                    // seta os campos a cor cinza apos logar
                    txtUsuario.setBackground(Color.GRAY);
                    txtSenha.setBackground(Color.GRAY);
                    this.dispose(); // fecha a tela principal depois que logar
                    //conexao.close(); // fecha a conexão com o banco depois de logar
                    
                }else{
//                    MenuPrincipal principal = new MenuPrincipal();
//                    principal.setVisible(true);
//                  pega o nome do usuario campo 2 e joga no menu principal
                    MenuPrincipal.lblUsuario.setText(rs.getString(2));
                    this.dispose(); 
                    //conexao.close(); 
                }
